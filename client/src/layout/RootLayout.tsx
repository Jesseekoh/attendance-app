...
export const RootLayout = () => {
  ...
  return (
    <>
          ...
          <div className="flex gap-6 items-center">
            {user ? (
              ...
              <>
                ...
                <Link to={'/signup'}>
                  <button className="px-4 py-2 rounded-lg text-white bg-emerald-400 ">
                    Sign up
                  </button>
                </Link>
              </>
      ...
      <footer className="footer footer-horizontal footer-center bg-neutral text-neutral-content p-10 mt-auto">
        <aside>
          <svg
            width="50"
            height="50"
